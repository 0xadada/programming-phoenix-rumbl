...
var videoElement = document.getElementById('video'); // Brunch automatically concatenates all files in your
...
_video2.default.init(_socket2.default, videoElement);

});

require.register("js/player.js", function(exports, require, module) {
"use strict";
...
var video = {
  ...
  onReady: function onReady(videoId, socket) {
    ...
    postButton.addEventListener('click', function (e) {
      var payload = {
        body: msgInput.value,
        at: _player2.default.getCurrentTime()
      };
    ...
    vidChannel.join().receive('ok', function (resp) {
      ...
      return console.log('join failed', msg);
    });
  },
  htmlSafe: function htmlSafe(str) {
  ...
  renderAnnotation: function renderAnnotation(msgContainer, _ref) {
    ...
    template.innerHTML = '\n    <a href="#" data-seek="' + this.htmlSafe(at) + '">\n      [' + this.formatTime(at) + ']\n      <strong>' + this.htmlSafe(user.username) + '</strong>: ' + this.htmlSafe(body) + '\n    </a>\n    ';
