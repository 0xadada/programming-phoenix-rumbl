defmodule RumblWeb.VideoChannel do
  ...
  def join("videos:" <> video_id, params, socket) do
    ...
    video = Repo.get!(Rumbl.Medias.Video, video_id)
    ...
    resp = %{
      annotations: Phoenix.View.render_many(annotations,
                                            AnnotationView,
                                            "annotation.json")}
  ...
  def handle_in("new_annotation", params, user, socket) do
    changeset =
      ...
      |> Rumbl.Medias.Annotation.changeset(params)
  ...
  defp compute_additional_info(ann, socket) do
    for result <- Rumbl.InfoSys.compute(ann.body, limit: 1, timeout: 10_000) do
      ...
      info_changeset =
        ...
        |> Rumbl.Medias.Annotation.changeset(attrs)
